...
| 参数名                          |         类型          |  必须  |       默认值        | 参数描述                                    |
| :--------------------------- | :-----------------: | :--: | :--------------: | --------------------------------------- |
| path_or_dir                  | String\|COS::COSDir |  是   |        无         | 需要上传至的目录路径或目录对象COSDir                   |
...
| 参数名                      |          类型          |  必须  |      默认值      | 参数描述                          |
| :----------------------- | :------------------: | :--: | :-----------: | ----------------------------- |
| path_or_file             | String\|COS::COSFile |  是   |       无       | 需要下载的文件路径或文件对象COSFile         |
...
| 参数名             |         类型          |  必须  | 默认值  | 参数描述                    |
| :-------------- | :-----------------: | :--: | :--: | ----------------------- |
| path_or_dir     | String\|COS::COSDir |  否   |  空   | 目录路径或目录对象COSDir,默认获取根目录 |
| options         |        Hash         |      |      |                         |
...
| 参数名                      |         类型          |  必须  |      默认值      | 参数描述                          |
| :----------------------- | :-----------------: | :--: | :-----------: | ----------------------------- |
| path_or_dir              | String\|COS::COSDir |  是   |       无       | 目录路径或目录对象COSDir               |
